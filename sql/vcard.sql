...
create table CONTACT_MAIL_ADDRESS
(
    MAIL_ADDRESS_ID MEDIUMINT NOT NULL AUTO_INCREMENT,
...
create table CONTACT_REL_MAIL_ADDRESS
(
    CONTACT_ID MEDIUMINT NOT NULL,
    MAIL_ADDRESS_ID MEDIUMINT NOT NULL,
    FOREIGN KEY(CONTACT_ID) REFERENCES CONTACT(CONTACT_ID),
    FOREIGN KEY(MAIL_ADDRESS_ID) REFERENCES CONTACT_MAIL_ADDRESS(MAIL_ADDRESS_ID),
...
--
create table CONTACT_MAIL_ADDRESS_REL_TYPES
(
    MAIL_ADDRESS_ID MEDIUMINT NOT NULL,
    TYPE_NAME VARCHAR(20) NOT NULL,
    FOREIGN KEY(MAIL_ADDRESS_ID) REFERENCES CONTACT_MAIL_ADDRESS(MAIL_ADDRESS_ID),
    PRIMARY KEY(MAIL_ADDRESS_ID,TYPE_NAME)
);
